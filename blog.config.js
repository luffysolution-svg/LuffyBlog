...
const BLOG = {
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '', // 可选：通过环境变量覆盖 Notion 数据库标题
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '', // 可选：通过环境变量覆盖 Notion 数据库描述
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '', // 可选：通过环境变量覆盖 Notion 数据库图标
