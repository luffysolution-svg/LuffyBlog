const CONFIG = {
  ...
  PREVIEW_CATEGORY_COUNT: 0, // 首页最多展示的分类数量，0为不限制（与 Notion 配置表中的通用 key 一致）
  PREVIEW_TAG_COUNT: 0, // 首页最多展示的标签数量，0为不限制（与 Notion 配置表中的通用 key 一致）
  ...
  HEXO_WIDGET_ANALYTICS: process.env.NEXT_PUBLIC_HEXO_WIDGET_ANALYTICS ?? true, // 显示统计卡
